...
public interface IResourceManager {
  ...
  <T extends AbstractWrapper<?> & ITypeToBuy> boolean canSpendResourcesOn(T t, int agentId);

  <T extends AbstractWrapper<?> & ITypeToBuy> void makeReservation(T t, int agentId);

  <T extends AbstractWrapper<?> & ITypeToBuy> void removeReservation(T t, int agentId);

  void removeAllReservations(int agentId);

  <T extends AbstractWrapper<?> & ITypeToBuy> boolean hasMadeReservationOn(T t, int agentId);
