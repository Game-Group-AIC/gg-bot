...
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_IDLE_DRONES;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_MINERALS;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_MINERALS_ON_BASE;
...
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_SUPPLY_BY_OVERLORDS;
import static aic.gas.abstract_bot.model.bot.FactConverters.CURRENT_POPULATION;
import static aic.gas.abstract_bot.model.bot.FactConverters.HAS_SELECTED_MINERAL_TO_MINE;
import static aic.gas.abstract_bot.model.bot.FactConverters.IS_CARRYING_GAS;
import static aic.gas.abstract_bot.model.bot.FactConverters.IS_CARRYING_MINERAL;
import static aic.gas.abstract_bot.model.bot.FactConverters.IS_CONSTRUCTING_BUILDING;
import static aic.gas.abstract_bot.model.bot.FactConverters.IS_MINING_GAS;
import static aic.gas.abstract_bot.model.bot.FactConverters.IS_MINING_MINERAL;
import static aic.gas.abstract_bot.model.bot.FactConverters.IS_WAITING_ON_GAS;
import static aic.gas.abstract_bot.model.bot.FactConverters.IS_WAITING_ON_MINERAL;
import static aic.gas.abstract_bot.model.bot.FactConverters.LAST_OBSERVATION;
import static aic.gas.abstract_bot.model.bot.FactConverters.MADE_BUILDING_LAST_CHECK;
...
import static aic.gas.abstract_bot.model.bot.FactKeys.BASE_TO_SCOUT_BY_WORKER;
import static aic.gas.abstract_bot.model.bot.FactKeys.BUILDING_LAST_CHECK;
import static aic.gas.abstract_bot.model.bot.FactKeys.ENEMY_UNIT;
import static aic.gas.abstract_bot.model.bot.FactKeys.HAS_BASE;
import static aic.gas.abstract_bot.model.bot.FactKeys.HAS_ENOUGH_RESOURCES;
import static aic.gas.abstract_bot.model.bot.FactKeys.HAS_EXTRACTOR;
import static aic.gas.abstract_bot.model.bot.FactKeys.IDLE_SINCE;
...
import static aic.gas.abstract_bot.model.bot.FactKeys.IS_GATHERING_GAS;
import static aic.gas.abstract_bot.model.bot.FactKeys.IS_GATHERING_MINERALS;
...
import static aic.gas.abstract_bot.model.bot.FactKeys.MINERAL_TO_MINE;
import static aic.gas.abstract_bot.model.bot.FactKeys.MINING_IN_EXTRACTOR;
import static aic.gas.abstract_bot.model.bot.FactKeys.MINING_MINERAL;
import static aic.gas.abstract_bot.model.bot.FactKeys.MORPH_TO;
import static aic.gas.abstract_bot.model.bot.FactKeys.OWN_BUILDING;
import static aic.gas.abstract_bot.model.bot.FactKeys.PLACE_FOR_CREEP_COLONY;
import static aic.gas.abstract_bot.model.bot.FactKeys.PLACE_FOR_EVOLUTION_CHAMBER;
import static aic.gas.abstract_bot.model.bot.FactKeys.PLACE_FOR_EXPANSION;
import static aic.gas.abstract_bot.model.bot.FactKeys.PLACE_FOR_EXTRACTOR;
import static aic.gas.abstract_bot.model.bot.FactKeys.PLACE_FOR_HYDRALISK_DEN;
import static aic.gas.abstract_bot.model.bot.FactKeys.PLACE_FOR_POOL;
import static aic.gas.abstract_bot.model.bot.FactKeys.PLACE_FOR_SPIRE;
import static aic.gas.abstract_bot.model.bot.FactKeys.PLACE_TO_GO;
...
import static aic.gas.abstract_bot.model.bot.FactKeys.WORKER_MINING_GAS;
import static aic.gas.abstract_bot.model.bot.FactKeys.WORKER_ON_BASE;
import static aic.gas.abstract_bot.model.game.wrappers.AUnitTypeWrapper.LAIR_TYPE;
import static aic.gas.abstract_bot.model.game.wrappers.AUnitTypeWrapper.SPORE_COLONY_TYPE;
import static aic.gas.abstract_bot.model.game.wrappers.AUnitTypeWrapper.SUNKEN_COLONY_TYPE;

import aic.gas.abstract_bot.model.bot.AgentTypes;
import aic.gas.abstract_bot.model.bot.FactKeys;
import aic.gas.abstract_bot.model.game.wrappers.ABaseLocationWrapper;
import aic.gas.abstract_bot.model.game.wrappers.APosition;
import aic.gas.abstract_bot.model.game.wrappers.ATilePosition;
...
import aic.gas.sc.gg_bot.utils.Util;
import bwapi.Order;
