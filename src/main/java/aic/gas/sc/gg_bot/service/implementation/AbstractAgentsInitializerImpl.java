...
import static aic.gas.abstract_bot.model.bot.AgentTypes.PLAYER;
import static aic.gas.abstract_bot.model.bot.FactConverters.CAN_TRANSIT_FROM_5_POOL;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_EVOLUTION_CHAMBERS;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_EVOLUTION_CHAMBERS_IN_CONSTRUCTION;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_EXTRACTORS;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_GAS;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_HATCHERIES;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_HATCHERIES_BEGINNING_CONSTRUCTION;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_HATCHERIES_BEING_CONSTRUCT;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_HATCHERIES_IN_CONSTRUCTION;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_HETCH;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_HYDRALISK_DENS;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_HYDRALISK_DENS_IN_CONSTRUCTION;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_LAIRS;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_LAIRS_IN_CONSTRUCTION;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_MINERALS;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_MINERALS_TO_MINE;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_MORPHING_OVERLORDS;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_POOLS;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_POOLS_IN_CONSTRUCTION;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_SPIRES;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_SPIRES_IN_CONSTRUCTION;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_WORKERS;
import static aic.gas.abstract_bot.model.bot.FactConverters.CURRENT_POPULATION;
import static aic.gas.abstract_bot.model.bot.FactConverters.MAX_POPULATION;
import static aic.gas.abstract_bot.model.bot.FactKeys.BASE_TO_MOVE;
import static aic.gas.abstract_bot.model.bot.FactKeys.HAS_BASE;
import static aic.gas.abstract_bot.model.bot.FactKeys.IS_BASE;
import static aic.gas.abstract_bot.model.bot.FactKeys.IS_BASE_LOCATION;
import static aic.gas.abstract_bot.model.bot.FactKeys.IS_ENEMY_BASE;
...
import static aic.gas.abstract_bot.model.bot.FactKeys.LAST_TIME_EXTRACTOR_BUILD;
import static aic.gas.abstract_bot.model.bot.FactKeys.LAST_TIME_HATCHERY_BUILD;
...
import static aic.gas.abstract_bot.model.bot.FeatureContainerHeaders.BOOSTING_AIR;
import static aic.gas.abstract_bot.model.bot.FeatureContainerHeaders.BOOSTING_GROUND_MELEE;
import static aic.gas.abstract_bot.model.bot.FeatureContainerHeaders.BOOSTING_GROUND_RANGED;
import static aic.gas.abstract_bot.model.bot.FeatureContainerHeaders.BUILDING_EVOLUTION_CHAMBER;
import static aic.gas.abstract_bot.model.bot.FeatureContainerHeaders.BUILDING_EXTRACTOR;
import static aic.gas.abstract_bot.model.bot.FeatureContainerHeaders.BUILDING_HYDRALISK_DEN;
import static aic.gas.abstract_bot.model.bot.FeatureContainerHeaders.BUILDING_POOL;
import static aic.gas.abstract_bot.model.bot.FeatureContainerHeaders.BUILDING_SPIRE;
import static aic.gas.abstract_bot.model.bot.FeatureContainerHeaders.EXPANDING;
import static aic.gas.abstract_bot.model.bot.FeatureContainerHeaders.INCREASING_CAPACITY;
import static aic.gas.abstract_bot.model.bot.FeatureContainerHeaders.TRAINING_WORKER;
import static aic.gas.abstract_bot.model.bot.FeatureContainerHeaders.UPGRADING_TO_LAIR;
import static aic.gas.sc.gg_bot.model.DesiresKeys.BOOST_AIR;
import static aic.gas.sc.gg_bot.model.DesiresKeys.BOOST_GROUND_MELEE;
import static aic.gas.sc.gg_bot.model.DesiresKeys.BOOST_GROUND_RANGED;
import static aic.gas.sc.gg_bot.model.DesiresKeys.BUILD_EXTRACTOR;
import static aic.gas.sc.gg_bot.model.DesiresKeys.BUILD_WORKER;
import static aic.gas.sc.gg_bot.model.DesiresKeys.ENABLE_AIR;
import static aic.gas.sc.gg_bot.model.DesiresKeys.ENABLE_GROUND_MELEE;
import static aic.gas.sc.gg_bot.model.DesiresKeys.ENABLE_GROUND_RANGED;
import static aic.gas.sc.gg_bot.model.DesiresKeys.ENABLE_STATIC_ANTI_AIR;
import static aic.gas.sc.gg_bot.model.DesiresKeys.EXPAND;
import static aic.gas.sc.gg_bot.model.DesiresKeys.HOLD_AIR;
import static aic.gas.sc.gg_bot.model.DesiresKeys.HOLD_GROUND;
import static aic.gas.sc.gg_bot.model.DesiresKeys.INCREASE_CAPACITY;
import static aic.gas.sc.gg_bot.model.DesiresKeys.MORPH_TO_DRONE;
import static aic.gas.sc.gg_bot.model.DesiresKeys.MORPH_TO_EVOLUTION_CHAMBER;
import static aic.gas.sc.gg_bot.model.DesiresKeys.MORPH_TO_EXTRACTOR;
import static aic.gas.sc.gg_bot.model.DesiresKeys.MORPH_TO_HYDRALISK_DEN;
import static aic.gas.sc.gg_bot.model.DesiresKeys.MORPH_TO_OVERLORD;
import static aic.gas.sc.gg_bot.model.DesiresKeys.MORPH_TO_POOL;
import static aic.gas.sc.gg_bot.model.DesiresKeys.MORPH_TO_SPIRE;
import static aic.gas.sc.gg_bot.model.DesiresKeys.MORPH_TO_SPORE_COLONY;
import static aic.gas.sc.gg_bot.model.DesiresKeys.MORPH_TO_SUNKEN_COLONY;
import static aic.gas.sc.gg_bot.model.DesiresKeys.UPGRADE_TO_LAIR;
...
import aic.gas.sc.gg_bot.model.Decider;
