...
import static aic.gas.abstract_bot.model.bot.AgentTypes.HATCHERY;
import static aic.gas.abstract_bot.model.bot.AgentTypes.LAIR;
import static aic.gas.abstract_bot.model.bot.AgentTypes.PLAYER;
import static aic.gas.abstract_bot.model.bot.FactConverters.BASE_IS_COMPLETED;
import static aic.gas.abstract_bot.model.bot.FactConverters.CAN_TRANSIT_FROM_5_POOL;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_CREEP_COLONIES_AT_BASE;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_CREEP_COLONIES_AT_BASE_IN_CONSTRUCTION;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_EXTRACTORS_ON_BASE;
...
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_SPORE_COLONIES_AT_BASE;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_SPORE_COLONIES_AT_BASE_IN_CONSTRUCTION;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_SUNKEN_COLONIES_AT_BASE;
import static aic.gas.abstract_bot.model.bot.FactConverters.COUNT_OF_SUNKEN_COLONIES_AT_BASE_IN_CONSTRUCTION;
import static aic.gas.abstract_bot.model.bot.FactKeys.BASE_TO_MOVE;
import static aic.gas.abstract_bot.model.bot.FactKeys.CREEP_COLONY_COUNT;
import static aic.gas.abstract_bot.model.bot.FactKeys.ENEMY_AIR;
import static aic.gas.abstract_bot.model.bot.FactKeys.ENEMY_AIR_FORCE_STATUS;
import static aic.gas.abstract_bot.model.bot.FactKeys.ENEMY_BUILDING;
import static aic.gas.abstract_bot.model.bot.FactKeys.ENEMY_BUILDING_STATUS;
import static aic.gas.abstract_bot.model.bot.FactKeys.ENEMY_GROUND;
import static aic.gas.abstract_bot.model.bot.FactKeys.ENEMY_GROUND_FORCE_STATUS;
import static aic.gas.abstract_bot.model.bot.FactKeys.ENEMY_STATIC_AIR_FORCE_STATUS;
import static aic.gas.abstract_bot.model.bot.FactKeys.ENEMY_STATIC_GROUND_FORCE_STATUS;
...
import static aic.gas.abstract_bot.model.bot.FactKeys.LAST_CREEP_COLONY_BUILDING_TIME;
import static aic.gas.abstract_bot.model.bot.FactKeys.LAST_SPORE_COLONY_BUILDING_TIME;
import static aic.gas.abstract_bot.model.bot.FactKeys.LAST_SUNKEN_COLONY_BUILDING_TIME;
...
import static aic.gas.abstract_bot.model.bot.FactKeys.LOCKED_BUILDINGS;
import static aic.gas.abstract_bot.model.bot.FactKeys.LOCKED_UNITS;
import static aic.gas.abstract_bot.model.bot.FactKeys.MADE_OBSERVATION_IN_FRAME;
import static aic.gas.abstract_bot.model.bot.FactKeys.OUR_UNIT;
import static aic.gas.abstract_bot.model.bot.FactKeys.OWN_AIR;
import static aic.gas.abstract_bot.model.bot.FactKeys.OWN_AIR_FORCE_STATUS;
import static aic.gas.abstract_bot.model.bot.FactKeys.OWN_BUILDING;
import static aic.gas.abstract_bot.model.bot.FactKeys.OWN_BUILDING_STATUS;
import static aic.gas.abstract_bot.model.bot.FactKeys.OWN_GROUND;
import static aic.gas.abstract_bot.model.bot.FactKeys.OWN_GROUND_FORCE_STATUS;
import static aic.gas.abstract_bot.model.bot.FactKeys.OWN_STATIC_AIR_FORCE_STATUS;
import static aic.gas.abstract_bot.model.bot.FactKeys.OWN_STATIC_GROUND_FORCE_STATUS;
import static aic.gas.abstract_bot.model.bot.FactKeys.REPRESENTS_UNIT;
import static aic.gas.abstract_bot.model.bot.FactKeys.SPORE_COLONY_COUNT;
import static aic.gas.abstract_bot.model.bot.FactKeys.STATIC_DEFENSE;
import static aic.gas.abstract_bot.model.bot.FactKeys.SUNKEN_COLONY_COUNT;
...
import static aic.gas.abstract_bot.model.bot.FactKeys.WORKER_MINING_MINERALS;
import static aic.gas.abstract_bot.model.bot.FactKeys.WORKER_ON_BASE;
import static aic.gas.abstract_bot.model.bot.FeatureContainerHeaders.DEFENSE;
import static aic.gas.abstract_bot.model.bot.FeatureContainerHeaders.HOLDING;
...
import aic.gas.sc.gg_bot.model.DesiresKeys;
