...
import static aic.gas.abstract_bot.model.bot.AgentTypes.BASE_LOCATION;
...
import static aic.gas.abstract_bot.model.bot.FactKeys.AVAILABLE_GAS;
import static aic.gas.abstract_bot.model.bot.FactKeys.AVAILABLE_MINERALS;
...
import static aic.gas.abstract_bot.model.bot.FactKeys.ENEMY_BASE;
...
import static aic.gas.abstract_bot.model.bot.FactKeys.ENEMY_RACE;
...
import static aic.gas.abstract_bot.model.bot.FactKeys.IS_PLAYER;
...
import static aic.gas.abstract_bot.model.bot.FactKeys.LING;
...
import static aic.gas.abstract_bot.model.bot.FactKeys.MORPHED_WORKERS;
import static aic.gas.abstract_bot.model.bot.FactKeys.OUR_BASE;
...
import static aic.gas.abstract_bot.model.bot.FactKeys.POPULATION;
import static aic.gas.abstract_bot.model.bot.FactKeys.POPULATION_LIMIT;
import static aic.gas.abstract_bot.model.bot.FactKeys.TECH_TO_RESEARCH;
import static aic.gas.abstract_bot.model.bot.FactKeys.TIME_OF_HOLD_COMMAND;
import static aic.gas.abstract_bot.model.bot.FactKeys.TIME_OF_LAST_DRONE;
import static aic.gas.abstract_bot.model.bot.FactKeys.TRANSIT_FROM_5_POOL;
import static aic.gas.abstract_bot.model.bot.FactKeys.UPGRADE_STATUS;
import static aic.gas.abstract_bot.model.bot.FactKeys.WERE_6_LINGS_MORPHED;
import static aic.gas.sc.gg_bot.model.DesiresKeys.BOOST_GROUND_MELEE;
import static aic.gas.sc.gg_bot.model.DesiresKeys.DO_5_POOL;
import static aic.gas.sc.gg_bot.model.DesiresKeys.ESTIMATE_ENEMY_FORCE;
import static aic.gas.sc.gg_bot.model.DesiresKeys.ESTIMATE_OUR_FORCE;
import static aic.gas.sc.gg_bot.model.DesiresKeys.FIND_ENEMY_BASE;
...
import static aic.gas.sc.gg_bot.model.DesiresKeys.READ_PLAYERS_DATA;
import static aic.gas.sc.gg_bot.model.DesiresKeys.REASON_ABOUT_BASES;
import static aic.gas.sc.gg_bot.model.DesiresKeys.REASON_ABOUT_TRANSITION;
import static aic.gas.sc.gg_bot.model.DesiresKeys.UPDATE_ENEMY_RACE;
import static aic.gas.sc.gg_bot.model.DesiresKeys.WORKER_SCOUT;
import static aic.gas.sc.gg_bot.service.implementation.AbstractAgentsInitializerImpl.FIND_MAIN_BASE;
...
import aic.gas.sc.gg_bot.model.agent.types.AgentTypePlayer;
